...
export default function CompanyProfile() {
  ...
  const handlePhotoUpload = async (e) => {
    ...
    try {
      ...
      addToast(
        err.response?.data?.message || "Failed to upload photos",
        "error",
      );
    } finally {
      setUploading(false);
        ...
        <Card>
          ...
          <div>
            ...
            <p
              ...
              style={{ color: "var(--color-text-muted)" }}
            >
              This description is visible to students when they click your
              company name
            </p>
          </div>
        </Card>
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p
              ...
              style={{ color: "var(--color-text-muted)" }}
            >
              Upload up to 5 photos of your office, team, or culture —{" "}
